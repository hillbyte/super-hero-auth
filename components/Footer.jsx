...
export default function Footer() {
  return (
    <MDBFooter className="text-center text-lg-left mt-auto shadow-lg">
      <MDBContainer className="p-4">
        <div className="row">
          <div className="col-lg-12 col-md-12 mb-12 mb-md-0">
            <h5 className="text-uppercase fw-bold mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-shield-fill me-2" viewBox="0 0 16 16">
            ...
            <p>
              Discover and manage superhero identities
            </p>
          </div>
      ...
      <div className="text-center p-3" style={{ backgroundColor: "var(--primary)", color: "var(--dark)" }}>
        &copy; {new Date().getFullYear()} Copyright:
        <Link href="/">
          <a className="text-dark ms-1 fw-bold">Super Heroes</a>
        </Link>
      </div>
    </MDBFooter>
  );
